...
export class Person {
	...
	constructor(city?: string | null, firstName?: string | null, isAddressResidential?: boolean | null, lastName?: string | null, state?: string | null, streetAddress?: string | null, zip?: string | null) {
		this.city = city ?? null;
		this.firstName = firstName ?? null;
		this.isAddressResidential = isAddressResidential ?? null;
...
export const PersonResolver: Resolver<Person> = async (values) => {
	...
	if (!values.isAddressResidential && values.isAddressResidential !== false) {
