...
export const PersonWithGenderFieldValueResolver: Resolver<PersonWithGenderFieldValue> = async (values) => {
	const errors: FieldErrors<PersonWithGenderFieldValue> = {};
...
export type PersonWithGenderFieldValueFormData = {
	personWithGenderFieldValue?: PersonWithGenderFieldValue,
	onSubmit: SubmitHandler<PersonWithGenderFieldValue>
};

export const PersonWithGenderFieldValueForm = (props: PersonWithGenderFieldValueFormData) => {
	const formId = useId();
	const { register, handleSubmit, formState: { errors, touchedFields, isSubmitting } } = useForm<PersonWithGenderFieldValue>({
		mode: "onTouched",
		resolver: PersonWithGenderFieldValueResolver,
		defaultValues: props.personWithGenderFieldValue ?? new PersonWithGenderFieldValue()
	});
