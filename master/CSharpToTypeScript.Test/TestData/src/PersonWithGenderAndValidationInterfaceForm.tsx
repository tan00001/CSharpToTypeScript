...
export type PersonWithGenderAndValidationInterfaceFormData = {
	personWithGenderAndValidationInterface?: PersonWithGenderAndValidationInterface,
	onSubmit: SubmitHandler<PersonWithGenderAndValidationInterface>
};

export const PersonWithGenderAndValidationInterfaceForm = (props: PersonWithGenderAndValidationInterfaceFormData) => {
	const formId = useId();
	const { register, handleSubmit, formState: { errors, touchedFields, isSubmitting } } = useForm<PersonWithGenderAndValidationInterface>({
		mode: "onTouched",
		resolver: PersonWithGenderAndValidationInterfaceResolver,
		defaultValues: props.personWithGenderAndValidationInterface ?? new PersonWithGenderAndValidationInterface()
	});
