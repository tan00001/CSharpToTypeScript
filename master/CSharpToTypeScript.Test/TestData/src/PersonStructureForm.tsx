...
export type PersonStructureFormData = {
	personStructure?: PersonStructure,
	onSubmit: SubmitHandler<PersonStructure>
};

export const PersonStructureForm = (props: PersonStructureFormData) => {
	const formId = useId();
	const { register, handleSubmit, formState: { errors, touchedFields, isSubmitting } } = useForm<PersonStructure>({
		mode: "onTouched",
		resolver: PersonStructureResolver,
		defaultValues: props.personStructure
	});
